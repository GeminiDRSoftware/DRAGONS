# -*- coding: utf-8 -*-
#
# QA Pipeline Operation documentation build configuration file, created by
...
project = u'QA Pipeline Operation'
copyright = u'2012, Kathleen Labrie'
...
htmlhelp_basename = 'QAPipelineOperationdoc'
