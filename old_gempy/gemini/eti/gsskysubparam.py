...
class GsskysubParam(PyrafETIParam):
    ...
    def __init__(self, rc=None, key=None, value=None):
        ...
        :type value: any
        """
        log.debug("GsskysubParam __init__")
