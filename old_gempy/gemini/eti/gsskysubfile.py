...
class GsskysubFile(PyrafETIFile):
    ...
    def __init__(self, rc=None, ad=None):
        ...
        """
        log.debug("GsskysubFile __init__")
        PyrafETIFile.__init__(self, rc)
        self.diskinlist = []
        self.diskoutlist = []
        self.taskname = "gsskysub"
...
class InAtList(GsskysubFile):
    ...
    def __init__(self, rc=None, ad=None):
        ...
        GsskysubFile.__init__(self, rc, ad)
        self.atlist = ""
...
class OutAtList(GsskysubFile):
    ...
    def prepare(self):
        ...
        log.fullinfo("Temporary list (%s) on disk for the IRAF task %s" % \
                      (self.atlist, self.taskname))
        self.filedict.update({"output": "@" + self.atlist})
