...
#                                                                        08-2013
# ------------------------------------------------------------------------------
# $Id: primitives_standardize.py 5823 2016-05-16 20:07:13Z csimpson $
# ------------------------------------------------------------------------------
__version__      = '$Revision: 5823 $'[11:-2]
__version_date__ = '$Date: 2016-05-16 17:07:13 -0300 (Mon, 16 May 2016) $'[7:-2]
# ------------------------------------------------------------------------------
import os
import os.path
import shutil
