...
def biassecStrTonbiascontam(biassec,ad):
    ...
    try:
            ...
            if biasseclist[2]==BIASSEClist[2] and biasseclist[3]==BIASSEClist[3]:
                if biasseclist[0]<50: # ie overscan/bias section is on the left side of chip
                    if biasseclist[0]==BIASSEClist[0]: 
                        ...
                        log.error('left horizontal components of biassec and BIASSEC did not match, so using default nbiascontam=4')
                        nbiascontam=4
                    ...
                    if biasseclist[1]==BIASSEClist[1]: 
                        ...
                        log.error('right horizontal components of biassec and BIASSEC did not match, so using default nbiascontam=4') 
                        nbiascontam=4
            else:
                log.error('vertical components of biassec and BIASSEC parameters did not match, so using default nbiascontam=4')
                nbiascontam=4
        ...
        log.error('An error ocured while trying to calculate the nbiascontam, so using default value = 4')
