...
class TestExposureGroup:
    ...
    def test_A_dith(self):
        ...
        #assert same_lists(gt.group_exposures(adpatt), (objgroup,))
    ...
    def test_ABBA(self):
        ...
        assert same_lists(gt.group_exposures(adpatt), (objgroup, skygroup))

    def test_ABBAACCA(self):
        ...
        assert same_lists(gt.group_exposures(adpatt), \
