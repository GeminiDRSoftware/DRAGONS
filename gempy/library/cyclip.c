...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "gempy.library.cyclip",
        "sources": [
            "/Users/osmirnov/DRAGONS/gempy/library/cyclip.pyx"
        ]
    },
    "module_name": "gempy.library.cyclip"
}
END: Cython Metadata */
...
#define __PYX_HAVE__gempy__library__cyclip
#define __PYX_HAVE_API__gempy__library__cyclip
/* Early includes */
#include <math.h>
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'gempy.library.cyclip' */
...
static float __pyx_f_5gempy_7library_6cyclip_median(float *, unsigned short *, int, int); /*proto*/
static void __pyx_f_5gempy_7library_6cyclip_mask_stats(float *, unsigned short *, int, long, int, double *); /*proto*/
static long __pyx_f_5gempy_7library_6cyclip_num_good(unsigned short *, long); /*proto*/
...
#define __Pyx_MODULE_NAME "gempy.library.cyclip"
extern int __pyx_module_is_main_gempy__library__cyclip;
int __pyx_module_is_main_gempy__library__cyclip = 0;

/* Implementation of 'gempy.library.cyclip' */
...
static const char __pyx_k_mclip[] = "mclip";
...
static const char __pyx_k_hsigma[] = "hsigma";
static const char __pyx_k_import[] = "__import__";
static const char __pyx_k_lsigma[] = "lsigma";
...
static const char __pyx_k_has_var[] = "has_var";
static const char __pyx_k_memview[] = "memview";
static const char __pyx_k_num_img[] = "num_img";
static const char __pyx_k_sigclip[] = "sigclip";
static const char __pyx_k_tmpdata[] = "tmpdata";
static const char __pyx_k_tmpmask[] = "tmpmask";
static const char __pyx_k_Ellipsis[] = "Ellipsis";
static const char __pyx_k_getstate[] = "__getstate__";
static const char __pyx_k_itemsize[] = "itemsize";
static const char __pyx_k_iterclip[] = "iterclip";
...
static const char __pyx_k_new_ngood[] = "new_ngood";
static const char __pyx_k_pyx_state[] = "__pyx_state";
static const char __pyx_k_reduce_ex[] = "__reduce_ex__";
static const char __pyx_k_IndexError[] = "IndexError";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_cyclip_pyx[] = "cyclip.pyx";
...
static const char __pyx_k_return_median[] = "return_median";
...
static const char __pyx_k_gempy_library_cyclip[] = "gempy.library.cyclip";
...
static PyObject *__pyx_kp_s_cyclip_pyx;
...
static PyObject *__pyx_n_s_gempy_library_cyclip;
static PyObject *__pyx_n_s_getstate;
static PyObject *__pyx_kp_s_got_differing_extents_in_dimensi;
static PyObject *__pyx_n_s_has_var;
static PyObject *__pyx_n_s_high_limit;
static PyObject *__pyx_n_s_hsigma;
...
static PyObject *__pyx_n_s_iterclip;
static PyObject *__pyx_n_s_low_limit;
static PyObject *__pyx_n_s_lsigma;
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_n_s_mask;
static PyObject *__pyx_n_s_max_iters;
static PyObject *__pyx_n_s_mclip;
...
static PyObject *__pyx_n_s_new_ngood;
...
static PyObject *__pyx_n_s_return_median;
static PyObject *__pyx_n_s_setstate;
static PyObject *__pyx_n_s_setstate_cython;
static PyObject *__pyx_n_s_shape;
static PyObject *__pyx_n_s_sigclip;
...
static PyObject *__pyx_n_s_tmpmask;
...
static PyObject *__pyx_pf_5gempy_7library_6cyclip_iterclip(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_mask, __Pyx_memviewslice __pyx_v_variance, int __pyx_v_has_var, int __pyx_v_num_img, long __pyx_v_data_size, double __pyx_v_lsigma, double __pyx_v_hsigma, int __pyx_v_max_iters, int __pyx_v_mclip, int __pyx_v_sigclip); /* proto */
...
static float __pyx_f_5gempy_7library_6cyclip_median(float *__pyx_v_data, unsigned short *__pyx_v_mask, int __pyx_v_has_mask, int __pyx_v_data_size) {
  float __pyx_v_x;
  float __pyx_v_y;
  float __pyx_v_med;
  int __pyx_v_i;
 ...
 *     if not tmp:
 */
  __pyx_v_tmp = ((float *)malloc((__pyx_v_data_size * (sizeof(float)))));

  /* "gempy/library/cyclip.pyx":51
 *     cdef float *tmp = <float *> malloc(data_size * sizeof(float))
 * 
 *     if not tmp:             # <<<<<<<<<<<<<<
 *         raise MemoryError()
 ...
 *             if mask[i] < 65535:
 */
  __pyx_t_1 = (__pyx_v_has_mask != 0);
  if (__pyx_t_1) {

    /* "gempy/library/cyclip.pyx":55
 * 
 *     if has_mask:
 *         for i in range(data_size):             # <<<<<<<<<<<<<<
 *             if mask[i] < 65535:
 ...
 *                 nused += 1
 */
      __pyx_t_1 = (((__pyx_v_mask[__pyx_v_i]) < 0xFFFF) != 0);
      if (__pyx_t_1) {

        /* "gempy/library/cyclip.pyx":57
 *         for i in range(data_size):
 *             if mask[i] < 65535:
 *                 tmp[nused] = data[i]             # <<<<<<<<<<<<<<
 *                 nused += 1
 ...
 */
        (__pyx_v_tmp[__pyx_v_nused]) = (__pyx_v_data[__pyx_v_i]);

        /* "gempy/library/cyclip.pyx":58
 *             if mask[i] < 65535:
 *                 tmp[nused] = data[i]
 *                 nused += 1             # <<<<<<<<<<<<<<
 *     if nused == 0:  # if not(has_mask) or all(mask)
 ...
 *             tmp[i] = data[i]
 */
  __pyx_t_1 = ((__pyx_v_nused == 0) != 0);
  if (__pyx_t_1) {

    /* "gempy/library/cyclip.pyx":60
 *                 nused += 1
 *     if nused == 0:  # if not(has_mask) or all(mask)
 *         for i in range(data_size):             # <<<<<<<<<<<<<<
 *             tmp[i] = data[i]
 ...
 * 
 */
      (__pyx_v_tmp[__pyx_v_i]) = (__pyx_v_data[__pyx_v_i]);
    }

    /* "gempy/library/cyclip.pyx":62
 *         for i in range(data_size):
 *             tmp[i] = data[i]
 *         nused = data_size             # <<<<<<<<<<<<<<
 * 
 *     ncycles = 2 - nused % 2
 */
    __pyx_v_nused = __pyx_v_data_size;
 ...
 *         k = (nused - 1) // 2 + cycle
 */
  __pyx_v_ncycles = (2 - __Pyx_mod_long(__pyx_v_nused, 2));

  /* "gempy/library/cyclip.pyx":65
 * 
 *     ncycles = 2 - nused % 2
 *     for cycle in range(0, ncycles):             # <<<<<<<<<<<<<<
 *         k = (nused - 1) // 2 + cycle
 *         l = 0
 */
  __pyx_t_2 = __pyx_v_ncycles;
  __pyx_t_3 = __pyx_t_2;
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_cycle = __pyx_t_4;

    /* "gempy/library/cyclip.pyx":66
 *     ncycles = 2 - nused % 2
 *     for cycle in range(0, ncycles):
 *         k = (nused - 1) // 2 + cycle             # <<<<<<<<<<<<<<
 *         l = 0
 *         m = nused - 1
 */
    __pyx_v_k = (__Pyx_div_long((__pyx_v_nused - 1), 2) + __pyx_v_cycle);

    /* "gempy/library/cyclip.pyx":67
 *     for cycle in range(0, ncycles):
 *         k = (nused - 1) // 2 + cycle
 *         l = 0             # <<<<<<<<<<<<<<
 *         m = nused - 1
 ...
 *             x = tmp[k]
 */
    __pyx_v_m = (__pyx_v_nused - 1);

    /* "gempy/library/cyclip.pyx":69
 *         l = 0
 *         m = nused - 1
 *         while (l < m):             # <<<<<<<<<<<<<<
 *             x = tmp[k]
 ...
 *             j = m
 */
      __pyx_v_x = (__pyx_v_tmp[__pyx_v_k]);

      /* "gempy/library/cyclip.pyx":71
 *         while (l < m):
 *             x = tmp[k]
 *             i = l             # <<<<<<<<<<<<<<
 *             j = m
 ...
 */
        while (1) {
          __pyx_t_1 = (((__pyx_v_tmp[__pyx_v_i]) < __pyx_v_x) != 0);
          if (!__pyx_t_1) break;

          /* "gempy/library/cyclip.pyx":75
 *             while True:
 *                 while (tmp[i] < x):
 *                     i += 1             # <<<<<<<<<<<<<<
 *                 while (x < tmp[j]):
 ...
 */
        while (1) {
          __pyx_t_1 = ((__pyx_v_x < (__pyx_v_tmp[__pyx_v_j])) != 0);
          if (!__pyx_t_1) break;

          /* "gempy/library/cyclip.pyx":77
 *                     i += 1
 *                 while (x < tmp[j]):
 *                     j -= 1             # <<<<<<<<<<<<<<
 *                 if i <= j:
 ...
 *                     tmp[j] = y
 */
          __pyx_v_y = (__pyx_v_tmp[__pyx_v_i]);

          /* "gempy/library/cyclip.pyx":80
 *                 if i <= j:
 *                     y = tmp[i]
 *                     tmp[i] = tmp[j]             # <<<<<<<<<<<<<<
 *                     tmp[j] = y
 *                     i += 1
 */
          (__pyx_v_tmp[__pyx_v_i]) = (__pyx_v_tmp[__pyx_v_j]);

          /* "gempy/library/cyclip.pyx":81
 *                     y = tmp[i]
 *                     tmp[i] = tmp[j]
 *                     tmp[j] = y             # <<<<<<<<<<<<<<
 *                     i += 1
 *                     j -= 1
 */
          (__pyx_v_tmp[__pyx_v_j]) = __pyx_v_y;

          /* "gempy/library/cyclip.pyx":82
 *                     tmp[i] = tmp[j]
 *                     tmp[j] = y
 *                     i += 1             # <<<<<<<<<<<<<<
 *                     j -= 1
 ...
 *         else:
 */
    __pyx_t_1 = ((__pyx_v_cycle == 0) != 0);
    if (__pyx_t_1) {

      /* "gempy/library/cyclip.pyx":91
 *                 m = j
 *         if cycle == 0:
 *             med = tmp[k]             # <<<<<<<<<<<<<<
 *         else:
 *             med = 0.5 * (med + tmp[k])
 */
      __pyx_v_med = (__pyx_v_tmp[__pyx_v_k]);
 ...
 */
    /*else*/ {
      __pyx_v_med = (0.5 * (__pyx_v_med + (__pyx_v_tmp[__pyx_v_k])));
    }
    __pyx_L25:;
  }

  /* "gempy/library/cyclip.pyx":95
 *             med = 0.5 * (med + tmp[k])
 * 
 *     free(tmp)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("gempy.library.cyclip.median", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1.0;
  __pyx_L0:;
...
static void __pyx_f_5gempy_7library_6cyclip_mask_stats(float *__pyx_v_data, unsigned short *__pyx_v_mask, int __pyx_v_has_mask, long __pyx_v_data_size, int __pyx_v_return_median, double *__pyx_v_result) {
  double __pyx_v_mean;
  double __pyx_v_sum;
  double __pyx_v_sumsq;
  double __pyx_v_sumall;
  double __pyx_v_sumsqall;
  int __pyx_v_i;
  int __pyx_v_nused;
  __Pyx_RefNannyDeclarations
  long __pyx_t_1;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("mask_stats", 0);

  /* "gempy/library/cyclip.pyx":126
 * 
 *     """
 ...
 */
  __pyx_t_1 = __pyx_v_data_size;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "gempy/library/cyclip.pyx":129
 *     cdef int i, nused = 0
 *     for i in range(data_size):
 *         sumall += data[i]             # <<<<<<<<<<<<<<
 *         sumsqall += data[i] * data[i]
 ...
 */
    __pyx_v_sumall = (__pyx_v_sumall + (__pyx_v_data[__pyx_v_i]));

    /* "gempy/library/cyclip.pyx":130
 *     for i in range(data_size):
 *         sumall += data[i]
 *         sumsqall += data[i] * data[i]             # <<<<<<<<<<<<<<
 *         if has_mask and mask[i] < 32768:
 *             sum += data[i]
 */
    __pyx_v_sumsqall = (__pyx_v_sumsqall + ((__pyx_v_data[__pyx_v_i]) * (__pyx_v_data[__pyx_v_i])));

    /* "gempy/library/cyclip.pyx":131
 *         sumall += data[i]
 *         sumsqall += data[i] * data[i]
 *         if has_mask and mask[i] < 32768:             # <<<<<<<<<<<<<<
 *             sum += data[i]
 *             sumsq += data[i] * data[i]
 */
    __pyx_t_5 = (__pyx_v_has_mask != 0);
    if (__pyx_t_5) {
    } else {
      __pyx_t_4 = __pyx_t_5;
      goto __pyx_L6_bool_binop_done;
    }
    __pyx_t_5 = (((__pyx_v_mask[__pyx_v_i]) < 0x8000) != 0);
    __pyx_t_4 = __pyx_t_5;
    __pyx_L6_bool_binop_done:;
    if (__pyx_t_4) {

      /* "gempy/library/cyclip.pyx":132
 *         sumsqall += data[i] * data[i]
 *         if has_mask and mask[i] < 32768:
 *             sum += data[i]             # <<<<<<<<<<<<<<
 *             sumsq += data[i] * data[i]
 ...
 *     if nused == 0:
 */
      __pyx_v_sumsq = (__pyx_v_sumsq + ((__pyx_v_data[__pyx_v_i]) * (__pyx_v_data[__pyx_v_i])));

      /* "gempy/library/cyclip.pyx":134
 *             sum += data[i]
 *             sumsq += data[i] * data[i]
 *             nused += 1             # <<<<<<<<<<<<<<
 *     if nused == 0:
 ...
 *         sumsq = sumsqall
 */
  __pyx_t_4 = ((__pyx_v_nused == 0) != 0);
  if (__pyx_t_4) {

    /* "gempy/library/cyclip.pyx":136
 *             nused += 1
 *     if nused == 0:
 *         sum = sumall             # <<<<<<<<<<<<<<
 *         sumsq = sumsqall
 *         nused = data_size
 */
    __pyx_v_sum = __pyx_v_sumall;

    /* "gempy/library/cyclip.pyx":137
 *     if nused == 0:
 *         sum = sumall
 *         sumsq = sumsqall             # <<<<<<<<<<<<<<
 *         nused = data_size
 ...
 */
    __pyx_v_sumsq = __pyx_v_sumsqall;

    /* "gempy/library/cyclip.pyx":138
 *         sum = sumall
 *         sumsq = sumsqall
 *         nused = data_size             # <<<<<<<<<<<<<<
 *     mean = sum / float(nused)
 ...
 */
  __pyx_v_mean = (__pyx_v_sum / ((double)__pyx_v_nused));

  /* "gempy/library/cyclip.pyx":140
 *         nused = data_size
 *     mean = sum / float(nused)
 *     if return_median:             # <<<<<<<<<<<<<<
 *         result[0] = <double>median(data, mask, has_mask, data_size)
 *     else:
 */
  __pyx_t_4 = (__pyx_v_return_median != 0);
  if (__pyx_t_4) {

    /* "gempy/library/cyclip.pyx":141
 *     mean = sum / float(nused)
 *     if return_median:
 *         result[0] = <double>median(data, mask, has_mask, data_size)             # <<<<<<<<<<<<<<
 *     else:
 *         result[0] = mean
 */
    __pyx_t_6 = __pyx_f_5gempy_7library_6cyclip_median(__pyx_v_data, __pyx_v_mask, __pyx_v_has_mask, __pyx_v_data_size); if (unlikely(__pyx_t_6 == ((float)-1.0) && PyErr_Occurred())) __PYX_ERR(0, 141, __pyx_L1_error)
    (__pyx_v_result[0]) = ((double)__pyx_t_6);
 ...
 */
  /*else*/ {
    (__pyx_v_result[0]) = __pyx_v_mean;
  }
  __pyx_L9:;

  /* "gempy/library/cyclip.pyx":144
 *     else:
 *         result[0] = mean
 *     result[1] = sumsq / nused - mean*mean             # <<<<<<<<<<<<<<
 * 
 * 
 */
  (__pyx_v_result[1]) = ((__pyx_v_sumsq / ((double)__pyx_v_nused)) - (__pyx_v_mean * __pyx_v_mean));
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("gempy.library.cyclip.mask_stats", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}

/* "gempy/library/cyclip.pyx":147
 * 
 * 
...
static long __pyx_f_5gempy_7library_6cyclip_num_good(unsigned short *__pyx_v_mask, long __pyx_v_data_size) {
  long __pyx_v_i;
  long __pyx_v_ngood;
  long __pyx_r;
  __Pyx_RefNannyDeclarations
  ...
  long __pyx_t_3;
  int __pyx_t_4;
  __Pyx_RefNannySetupContext("num_good", 0);

  /* "gempy/library/cyclip.pyx":163
 *         (add description)
 *     """
 *     cdef long i, ngood = 0             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
    __pyx_t_4 = (((__pyx_v_mask[__pyx_v_i]) < 0x8000) != 0);
    if (__pyx_t_4) {

      /* "gempy/library/cyclip.pyx":167
 *     for i in range(data_size):
 *         if mask[i] < 32768:
 *             ngood += 1             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pw_5gempy_7library_6cyclip_1iterclip(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("iterclip (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_data,&__pyx_n_s_mask,&__pyx_n_s_variance,&__pyx_n_s_has_var,&__pyx_n_s_num_img,&__pyx_n_s_data_size,&__pyx_n_s_lsigma,&__pyx_n_s_hsigma,&__pyx_n_s_max_iters,&__pyx_n_s_mclip,&__pyx_n_s_sigclip,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_mask)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("iterclip", 1, 11, 11, 1); __PYX_ERR(0, 174, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_variance)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("iterclip", 1, 11, 11, 2); __PYX_ERR(0, 174, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_has_var)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("iterclip", 1, 11, 11, 3); __PYX_ERR(0, 174, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_img)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("iterclip", 1, 11, 11, 4); __PYX_ERR(0, 174, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_data_size)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("iterclip", 1, 11, 11, 5); __PYX_ERR(0, 174, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lsigma)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("iterclip", 1, 11, 11, 6); __PYX_ERR(0, 174, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_hsigma)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("iterclip", 1, 11, 11, 7); __PYX_ERR(0, 174, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_max_iters)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("iterclip", 1, 11, 11, 8); __PYX_ERR(0, 174, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_mclip)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("iterclip", 1, 11, 11, 9); __PYX_ERR(0, 174, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sigclip)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("iterclip", 1, 11, 11, 10); __PYX_ERR(0, 174, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "iterclip") < 0)) __PYX_ERR(0, 174, __pyx_L3_error)
      }
    ...
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(0, 174, __pyx_L3_error)
    __pyx_v_mask = __Pyx_PyObject_to_MemoryviewSlice_ds_unsigned_short(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_mask.memview)) __PYX_ERR(0, 174, __pyx_L3_error)
    __pyx_v_variance = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_variance.memview)) __PYX_ERR(0, 174, __pyx_L3_error)
    __pyx_v_has_var = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_has_var == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 175, __pyx_L3_error)
    __pyx_v_num_img = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_num_img == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 175, __pyx_L3_error)
    __pyx_v_data_size = __Pyx_PyInt_As_long(values[5]); if (unlikely((__pyx_v_data_size == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 175, __pyx_L3_error)
    __pyx_v_lsigma = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_lsigma == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 175, __pyx_L3_error)
    __pyx_v_hsigma = __pyx_PyFloat_AsDouble(values[7]); if (unlikely((__pyx_v_hsigma == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 176, __pyx_L3_error)
    __pyx_v_max_iters = __Pyx_PyInt_As_int(values[8]); if (unlikely((__pyx_v_max_iters == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 176, __pyx_L3_error)
    __pyx_v_mclip = __Pyx_PyInt_As_int(values[9]); if (unlikely((__pyx_v_mclip == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 176, __pyx_L3_error)
    __pyx_v_sigclip = __Pyx_PyInt_As_int(values[10]); if (unlikely((__pyx_v_sigclip == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 176, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("iterclip", 1, 11, 11, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 174, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("gempy.library.cyclip.iterclip", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5gempy_7library_6cyclip_iterclip(__pyx_self, __pyx_v_data, __pyx_v_mask, __pyx_v_variance, __pyx_v_has_var, __pyx_v_num_img, __pyx_v_data_size, __pyx_v_lsigma, __pyx_v_hsigma, __pyx_v_max_iters, __pyx_v_mclip, __pyx_v_sigclip);
...
static PyObject *__pyx_pf_5gempy_7library_6cyclip_iterclip(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_mask, __Pyx_memviewslice __pyx_v_variance, int __pyx_v_has_var, int __pyx_v_num_img, long __pyx_v_data_size, double __pyx_v_lsigma, double __pyx_v_hsigma, int __pyx_v_max_iters, int __pyx_v_mclip, int __pyx_v_sigclip) {
  long __pyx_v_i;
  long __pyx_v_n;
  long __pyx_v_ngood;
  long __pyx_v_new_ngood;
  int __pyx_v_iter;
  int __pyx_v_return_median;
  double __pyx_v_result[2];
  double __pyx_v_avg;
  double __pyx_v_std;
  float __pyx_v_low_limit;
  float __pyx_v_high_limit;
  float *__pyx_v_tmpdata;
  unsigned short *__pyx_v_tmpmask;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("iterclip", 0);

  /* "gempy/library/cyclip.pyx":223
 ...
 *         raise MemoryError()
 */
  __pyx_v_tmpdata = ((float *)malloc((__pyx_v_num_img * (sizeof(float)))));

  /* "gempy/library/cyclip.pyx":224
 * 
 *     cdef float *tmpdata = <float *> malloc(num_img * sizeof(float))
 *     if not tmpdata:             # <<<<<<<<<<<<<<
 *         raise MemoryError()
 * 
 */
  __pyx_t_1 = ((!(__pyx_v_tmpdata != 0)) != 0);
  if (unlikely(__pyx_t_1)) {

    /* "gempy/library/cyclip.pyx":225
 *     cdef float *tmpdata = <float *> malloc(num_img * sizeof(float))
 *     if not tmpdata:
 *         raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 ...
 *         raise MemoryError()
 */
  __pyx_v_tmpmask = ((unsigned short *)malloc((__pyx_v_num_img * (sizeof(unsigned short)))));

  /* "gempy/library/cyclip.pyx":228
 * 
 *     cdef unsigned short *tmpmask = <unsigned short *> malloc(num_img * sizeof(unsigned short))
 *     if not tmpmask:             # <<<<<<<<<<<<<<
 *         raise MemoryError()
 * 
 */
  __pyx_t_1 = ((!(__pyx_v_tmpmask != 0)) != 0);
  if (unlikely(__pyx_t_1)) {

    /* "gempy/library/cyclip.pyx":229
 *     cdef unsigned short *tmpmask = <unsigned short *> malloc(num_img * sizeof(unsigned short))
 *     if not tmpmask:
 *         raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 *     if max_iters == 0:
 */
    PyErr_NoMemory(); __PYX_ERR(0, 229, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_1 = ((__pyx_v_max_iters == 0) != 0);
  if (__pyx_t_1) {

    /* "gempy/library/cyclip.pyx":232
 * 
 *     if max_iters == 0:
 *         max_iters = 100             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_return_median = 1;

    /* "gempy/library/cyclip.pyx":237
 *         iter = 0
 *         return_median = 1
 *         for n in range(num_img):             # <<<<<<<<<<<<<<
 *             tmpdata[n] = data[n*data_size+i]
 ...
 */
    __pyx_t_5 = __pyx_v_num_img;
    __pyx_t_6 = __pyx_t_5;
    for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      __pyx_v_n = __pyx_t_7;

      /* "gempy/library/cyclip.pyx":238
 *         return_median = 1
 *         for n in range(num_img):
 *             tmpdata[n] = data[n*data_size+i]             # <<<<<<<<<<<<<<
 *             tmpmask[n] = mask[n*data_size+i]
 ...
 */
      __pyx_t_8 = ((__pyx_v_n * __pyx_v_data_size) + __pyx_v_i);
      (__pyx_v_tmpdata[__pyx_v_n]) = (*((float *) ( /* dim=0 */ (__pyx_v_data.data + __pyx_t_8 * __pyx_v_data.strides[0]) )));

      /* "gempy/library/cyclip.pyx":239
 *         for n in range(num_img):
 *             tmpdata[n] = data[n*data_size+i]
 *             tmpmask[n] = mask[n*data_size+i]             # <<<<<<<<<<<<<<
 *         ngood = num_good(tmpmask, num_img)
 ...
 */
      __pyx_t_8 = ((__pyx_v_n * __pyx_v_data_size) + __pyx_v_i);
      (__pyx_v_tmpmask[__pyx_v_n]) = (*((unsigned short *) ( /* dim=0 */ (__pyx_v_mask.data + __pyx_t_8 * __pyx_v_mask.strides[0]) )));
    }

    /* "gempy/library/cyclip.pyx":240
 *             tmpdata[n] = data[n*data_size+i]
 *             tmpmask[n] = mask[n*data_size+i]
 *         ngood = num_good(tmpmask, num_img)             # <<<<<<<<<<<<<<
 *         while iter < max_iters:
 ...
 */
    __pyx_v_ngood = __pyx_f_5gempy_7library_6cyclip_num_good(__pyx_v_tmpmask, __pyx_v_num_img);

    /* "gempy/library/cyclip.pyx":241
 *             tmpmask[n] = mask[n*data_size+i]
 *         ngood = num_good(tmpmask, num_img)
 *         while iter < max_iters:             # <<<<<<<<<<<<<<
 *             mask_stats(tmpdata, tmpmask, 1, num_img, return_median, result)
 ...
 */
    while (1) {
      __pyx_t_1 = ((__pyx_v_iter < __pyx_v_max_iters) != 0);
      if (!__pyx_t_1) break;

      /* "gempy/library/cyclip.pyx":242
 *         ngood = num_good(tmpmask, num_img)
 *         while iter < max_iters:
 *             mask_stats(tmpdata, tmpmask, 1, num_img, return_median, result)             # <<<<<<<<<<<<<<
 *             avg = result[0]
 ...
 */
      __pyx_f_5gempy_7library_6cyclip_mask_stats(__pyx_v_tmpdata, __pyx_v_tmpmask, 1, __pyx_v_num_img, __pyx_v_return_median, __pyx_v_result);

      /* "gempy/library/cyclip.pyx":243
 *         while iter < max_iters:
 *             mask_stats(tmpdata, tmpmask, 1, num_img, return_median, result)
 *             avg = result[0]             # <<<<<<<<<<<<<<
 *             if has_var == 0 or sigclip:
 *                 std = sqrt(result[1])
 */
      __pyx_v_avg = (__pyx_v_result[0]);

      /* "gempy/library/cyclip.pyx":244
 *             mask_stats(tmpdata, tmpmask, 1, num_img, return_median, result)
 *             avg = result[0]
 *             if has_var == 0 or sigclip:             # <<<<<<<<<<<<<<
 *                 std = sqrt(result[1])
 ...
 */
      __pyx_t_9 = ((__pyx_v_has_var == 0) != 0);
      if (!__pyx_t_9) {
      } else {
        __pyx_t_1 = __pyx_t_9;
        goto __pyx_L13_bool_binop_done;
      }
      __pyx_t_9 = (__pyx_v_sigclip != 0);
      __pyx_t_1 = __pyx_t_9;
      __pyx_L13_bool_binop_done:;
      if (__pyx_t_1) {

        /* "gempy/library/cyclip.pyx":245
 *             avg = result[0]
 *             if has_var == 0 or sigclip:
 *                 std = sqrt(result[1])             # <<<<<<<<<<<<<<
 *                 low_limit = avg - lsigma * std
 ...
 */
        __pyx_v_std = sqrt((__pyx_v_result[1]));

        /* "gempy/library/cyclip.pyx":246
 *             if has_var == 0 or sigclip:
 *                 std = sqrt(result[1])
 *                 low_limit = avg - lsigma * std             # <<<<<<<<<<<<<<
 *                 high_limit = avg + hsigma * std
 *                 for n in range(num_img):
 */
        __pyx_v_low_limit = (__pyx_v_avg - (__pyx_v_lsigma * __pyx_v_std));

        /* "gempy/library/cyclip.pyx":247
 *                 std = sqrt(result[1])
 *                 low_limit = avg - lsigma * std
 *                 high_limit = avg + hsigma * std             # <<<<<<<<<<<<<<
 *                 for n in range(num_img):
 ...
 */
        __pyx_v_high_limit = (__pyx_v_avg + (__pyx_v_hsigma * __pyx_v_std));

        /* "gempy/library/cyclip.pyx":248
 *                 low_limit = avg - lsigma * std
 *                 high_limit = avg + hsigma * std
 *                 for n in range(num_img):             # <<<<<<<<<<<<<<
 *                     if tmpdata[n] < low_limit or tmpdata[n] > high_limit:
 ...
 *             else:
 */
          __pyx_t_9 = (((__pyx_v_tmpdata[__pyx_v_n]) < __pyx_v_low_limit) != 0);
          if (!__pyx_t_9) {
          } else {
            __pyx_t_1 = __pyx_t_9;
            goto __pyx_L18_bool_binop_done;
          }
          __pyx_t_9 = (((__pyx_v_tmpdata[__pyx_v_n]) > __pyx_v_high_limit) != 0);
          __pyx_t_1 = __pyx_t_9;
          __pyx_L18_bool_binop_done:;
          if (__pyx_t_1) {

            /* "gempy/library/cyclip.pyx":250
 *                 for n in range(num_img):
 *                     if tmpdata[n] < low_limit or tmpdata[n] > high_limit:
 *                         tmpmask[n] |= 32768             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
            ...
            (__pyx_v_tmpmask[__pyx_t_10]) = ((__pyx_v_tmpmask[__pyx_t_10]) | 0x8000);
 ...
 */
          __pyx_t_8 = ((__pyx_v_n * __pyx_v_data_size) + __pyx_v_i);
          __pyx_v_std = sqrt((*((float *) ( /* dim=0 */ (__pyx_v_variance.data + __pyx_t_8 * __pyx_v_variance.strides[0]) ))));

          /* "gempy/library/cyclip.pyx":254
 *                 for n in range(num_img):
 *                     std = sqrt(variance[n*data_size+i])
 *                     if tmpdata[n] < avg-lsigma*std or tmpdata[n] > avg+hsigma*std:             # <<<<<<<<<<<<<<
 *                         tmpmask[n] |= 32768
 * 
 */
          __pyx_t_9 = (((__pyx_v_tmpdata[__pyx_v_n]) < (__pyx_v_avg - (__pyx_v_lsigma * __pyx_v_std))) != 0);
          if (!__pyx_t_9) {
          } else {
            __pyx_t_1 = __pyx_t_9;
            goto __pyx_L23_bool_binop_done;
          }
          __pyx_t_9 = (((__pyx_v_tmpdata[__pyx_v_n]) > (__pyx_v_avg + (__pyx_v_hsigma * __pyx_v_std))) != 0);
          __pyx_t_1 = __pyx_t_9;
          __pyx_L23_bool_binop_done:;
          if (__pyx_t_1) {

            /* "gempy/library/cyclip.pyx":255
 *                     std = sqrt(variance[n*data_size+i])
 *                     if tmpdata[n] < avg-lsigma*std or tmpdata[n] > avg+hsigma*std:
 *                         tmpmask[n] |= 32768             # <<<<<<<<<<<<<<
 * 
 ...
 *                 break
 */
      __pyx_v_new_ngood = __pyx_f_5gempy_7library_6cyclip_num_good(__pyx_v_tmpmask, __pyx_v_num_img);

      /* "gempy/library/cyclip.pyx":258
 * 
 *             new_ngood = num_good(tmpmask, num_img)
 *             if new_ngood == ngood:             # <<<<<<<<<<<<<<
 *                 break
 *             if not mclip:
 */
      __pyx_t_1 = ((__pyx_v_new_ngood == __pyx_v_ngood) != 0);
      if (__pyx_t_1) {

        /* "gempy/library/cyclip.pyx":259
 *             new_ngood = num_good(tmpmask, num_img)
 *             if new_ngood == ngood:
 *                 break             # <<<<<<<<<<<<<<
 *             if not mclip:
 ...
 *             ngood = new_ngood
 */
      __pyx_t_1 = ((!(__pyx_v_mclip != 0)) != 0);
      if (__pyx_t_1) {

        /* "gempy/library/cyclip.pyx":261
 *                 break
 *             if not mclip:
 *                 return_median = 0             # <<<<<<<<<<<<<<
 *             ngood = new_ngood
 ...
 *         for n in range(num_img):
 */
      __pyx_v_ngood = __pyx_v_new_ngood;

      /* "gempy/library/cyclip.pyx":263
 *                 return_median = 0
 *             ngood = new_ngood
 *             iter += 1             # <<<<<<<<<<<<<<
 *         for n in range(num_img):
 ...
 */
      __pyx_t_8 = ((__pyx_v_n * __pyx_v_data_size) + __pyx_v_i);
      *((unsigned short *) ( /* dim=0 */ (__pyx_v_mask.data + __pyx_t_8 * __pyx_v_mask.strides[0]) )) = (__pyx_v_tmpmask[__pyx_v_n]);
    }
  }

  /* "gempy/library/cyclip.pyx":267
 *             mask[n*data_size+i] = tmpmask[n]
 * 
 *     free(tmpdata)             # <<<<<<<<<<<<<<
 *     free(tmpmask)
 ...
 */
  free(__pyx_v_tmpmask);

  /* "gempy/library/cyclip.pyx":270
 *     free(tmpmask)
 * 
 *     return np.asarray(data), np.asarray(mask), np.asarray(variance)             # <<<<<<<<<<<<<<
 */
  ...
  __pyx_t_13 = __Pyx_PyObject_GetAttrStr(__pyx_t_12, __pyx_n_s_asarray); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 270, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_13);
  __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
  __pyx_t_12 = __pyx_memoryview_fromslice(__pyx_v_data, 1, (PyObject *(*)(char *)) __pyx_memview_get_float, (int (*)(char *, PyObject *)) __pyx_memview_set_float, 0);; if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 270, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_t_14 = NULL;
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_12, __pyx_n_s_np); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 270, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_t_14 = __Pyx_PyObject_GetAttrStr(__pyx_t_12, __pyx_n_s_asarray); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 270, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_14);
  __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
  __pyx_t_12 = __pyx_memoryview_fromslice(__pyx_v_mask, 1, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_short, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_short, 0);; if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 270, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_t_15 = NULL;
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_12, __pyx_n_s_np); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 270, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_t_15 = __Pyx_PyObject_GetAttrStr(__pyx_t_12, __pyx_n_s_asarray); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 270, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_15);
  __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
  __pyx_t_12 = __pyx_memoryview_fromslice(__pyx_v_variance, 1, (PyObject *(*)(char *)) __pyx_memview_get_float, (int (*)(char *, PyObject *)) __pyx_memview_set_float, 0);; if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 270, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_t_16 = NULL;
  ...
  __pyx_t_14 = (__pyx_t_16) ? __Pyx_PyObject_Call2Args(__pyx_t_15, __pyx_t_16, __pyx_t_12) : __Pyx_PyObject_CallOneArg(__pyx_t_15, __pyx_t_12);
  __Pyx_XDECREF(__pyx_t_16); __pyx_t_16 = 0;
  __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
  if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 270, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_14);
  __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
  __pyx_t_15 = PyTuple_New(3); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 270, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_15);
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_variance, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "gempy.library.cyclip.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "gempy.library.cyclip.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "gempy.library.cyclip.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "gempy.library.cyclip._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_cyclip(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cyclip},
  {0, NULL}
};
#endif
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "cyclip",
    __pyx_k_If_switching_to_new_versions_of, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_cyclip_pyx, __pyx_k_cyclip_pyx, sizeof(__pyx_k_cyclip_pyx), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_gempy_library_cyclip, __pyx_k_gempy_library_cyclip, sizeof(__pyx_k_gempy_library_cyclip), 0, 0, 1, 1},
  {&__pyx_n_s_getstate, __pyx_k_getstate, sizeof(__pyx_k_getstate), 0, 0, 1, 1},
  {&__pyx_kp_s_got_differing_extents_in_dimensi, __pyx_k_got_differing_extents_in_dimensi, sizeof(__pyx_k_got_differing_extents_in_dimensi), 0, 0, 1, 0},
  {&__pyx_n_s_has_var, __pyx_k_has_var, sizeof(__pyx_k_has_var), 0, 0, 1, 1},
  {&__pyx_n_s_high_limit, __pyx_k_high_limit, sizeof(__pyx_k_high_limit), 0, 0, 1, 1},
  {&__pyx_n_s_hsigma, __pyx_k_hsigma, sizeof(__pyx_k_hsigma), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_iterclip, __pyx_k_iterclip, sizeof(__pyx_k_iterclip), 0, 0, 1, 1},
  {&__pyx_n_s_low_limit, __pyx_k_low_limit, sizeof(__pyx_k_low_limit), 0, 0, 1, 1},
  {&__pyx_n_s_lsigma, __pyx_k_lsigma, sizeof(__pyx_k_lsigma), 0, 0, 1, 1},
  {&__pyx_n_s_main, __pyx_k_main, sizeof(__pyx_k_main), 0, 0, 1, 1},
  {&__pyx_n_s_mask, __pyx_k_mask, sizeof(__pyx_k_mask), 0, 0, 1, 1},
  {&__pyx_n_s_max_iters, __pyx_k_max_iters, sizeof(__pyx_k_max_iters), 0, 0, 1, 1},
  {&__pyx_n_s_mclip, __pyx_k_mclip, sizeof(__pyx_k_mclip), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_new_ngood, __pyx_k_new_ngood, sizeof(__pyx_k_new_ngood), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_return_median, __pyx_k_return_median, sizeof(__pyx_k_return_median), 0, 0, 1, 1},
  {&__pyx_n_s_setstate, __pyx_k_setstate, sizeof(__pyx_k_setstate), 0, 0, 1, 1},
  {&__pyx_n_s_setstate_cython, __pyx_k_setstate_cython, sizeof(__pyx_k_setstate_cython), 0, 0, 1, 1},
  {&__pyx_n_s_shape, __pyx_k_shape, sizeof(__pyx_k_shape), 0, 0, 1, 1},
  {&__pyx_n_s_sigclip, __pyx_k_sigclip, sizeof(__pyx_k_sigclip), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_tmpmask, __pyx_k_tmpmask, sizeof(__pyx_k_tmpmask), 0, 0, 1, 1},
 ...
 *              double hsigma, int max_iters, int mclip, int sigclip):
 */
  __pyx_tuple__19 = PyTuple_Pack(25, __pyx_n_s_data, __pyx_n_s_mask, __pyx_n_s_variance, __pyx_n_s_has_var, __pyx_n_s_num_img, __pyx_n_s_data_size, __pyx_n_s_lsigma, __pyx_n_s_hsigma, __pyx_n_s_max_iters, __pyx_n_s_mclip, __pyx_n_s_sigclip, __pyx_n_s_i, __pyx_n_s_n, __pyx_n_s_ngood, __pyx_n_s_new_ngood, __pyx_n_s_iter, __pyx_n_s_return_median, __pyx_n_s_result, __pyx_n_s_avg, __pyx_n_s_var, __pyx_n_s_std, __pyx_n_s_low_limit, __pyx_n_s_high_limit, __pyx_n_s_tmpdata, __pyx_n_s_tmpmask); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 174, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(11, 0, 25, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cyclip_pyx, __pyx_n_s_iterclip, 174, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 174, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcyclip(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcyclip(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cyclip(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cyclip(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cyclip(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cyclip' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cyclip(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cyclip", __pyx_methods, __pyx_k_If_switching_to_new_versions_of, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_gempy__library__cyclip) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "gempy.library.cyclip")) {
      if (unlikely(PyDict_SetItemString(modules, "gempy.library.cyclip", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *              double hsigma, int max_iters, int mclip, int sigclip):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5gempy_7library_6cyclip_1iterclip, NULL, __pyx_n_s_gempy_library_cyclip); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 174, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_iterclip, __pyx_t_1) < 0) __PYX_ERR(0, 174, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "gempy/library/cyclip.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init gempy.library.cyclip", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init gempy.library.cyclip");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
