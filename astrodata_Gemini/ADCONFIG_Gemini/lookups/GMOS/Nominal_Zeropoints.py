nominal_zeropoints = {
    ...
    # Updating values supplied by German Gimeno on 2014-09-17, from
    # data taken 20140712.
    ...
    # CCDg = BI11-33-4k-1
    # CCDb = BI12-34-4k-1
    ('BI5-36-4k-2', 'u'): 24.213, # 0.042,
    ('BI11-33-4k-1', 'u'): 24.195, # 0.011,
    ('BI12-34-4k-1', 'u'): 24.263, # 0.052,
    ('BI5-36-4k-2,BI11-33-4k-1,BI12-34-4k-1', 'u'): 24.551, # 1.074, from Pascale
    ('BI5-36-4k-2', 'g'): 28.078, # 0.047,
    ('BI11-33-4k-1', 'g'): 28.058, # 0.050,
    ('BI12-34-4k-1', 'g'): 28.062, # 0.061,
    ('BI5-36-4k-2,BI11-33-4k-1,BI12-34-4k-1', 'g'): 28.002, # 0.312, from Pascale
    ('BI5-36-4k-2', 'r'): 28.243, # 0.038,
    ('BI11-33-4k-1', 'r'): 28.231, # 0.041,
    ('BI12-34-4k-1', 'r'): 28.258, # 0.049,
    ('BI5-36-4k-2,BI11-33-4k-1,BI12-34-4k-1', 'r'): 28.089, # 0.323, from Pascale
    ('BI5-36-4k-2', 'i'): 28.224, # 0.028,
    ('BI11-33-4k-1', 'i'): 28.215, # 0.036,
    ('BI12-34-4k-1', 'i'): 28.261, # 0.036,
    ('BI5-36-4k-2,BI11-33-4k-1,BI12-34-4k-1', 'i'): 28.159, # 0.379, from Pascale
    ('BI5-36-4k-2', 'z'): 27.887, # 0.021,
    ('BI11-33-4k-1', 'z'): 28.060, # 0.035,
    ('BI12-34-4k-1', 'z'): 28.063, # 0.038,
    ('BI5-36-4k-2,BI11-33-4k-1,BI12-34-4k-1', 'z'): 27.786, # 0.432, from Pascale
}
