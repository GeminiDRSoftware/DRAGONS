gmosampsGain = {
        # Database of GMOS CCD amplifier properties
        # GMOS-N bias for best amps change when in 6amp mode
        # READOUT GAINSTATE GAIN RDNOISE BIAS AMPNAME
        # GMOS-N
