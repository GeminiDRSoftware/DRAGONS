...
#    ('GMOS', 'N20110524S0358.fits') : ['AZEL_TARGET', 'CAL', 'GEMINI', 'NORTH', 'GMOS', 'BIAS', 'CAL', 'NON_SIDEREAL', 'RAW', 'UNPREPARED'],
#    ('GMOS', 'N20110524S0358_bias.fits') : ['AZEL_TARGET', 'CAL', 'GEMINI', 'NORTH', 'GMOS', 'BIAS', 'CAL', 'NON_SIDEREAL', 'OVERSCAN_SUBTRACTED', 'OVERSCAN_TRIMMED', 'PREPARED', 'PROCESSED'],
#    ('GMOS', 'S20110627S0151.fits') : ['AT_ZENITH', 'AZEL_TARGET', 'CAL', 'GEMINI', 'SOUTH', 'GMOS', 'BIAS', 'CAL', 'NON_SIDEREAL', 'RAW', 'UNPREPARED'],
#    ('GMOS', 'S20070318S0274_bias.fits'): ['AT_ZENITH', 'AZEL_TARGET', 'CAL', 'GEMINI', 'SOUTH', 'GMOS', 'BIAS', 'NON_SIDEREAL', 'OVERSCAN_SUBTRACTED', 'OVERSCAN_TRIMMED', 'PREPARED', 'PROCESSED'],
#
##   GMOS Dark
#    ('GMOS', 'N20160106S0653.fits') : ['AZEL_TARGET', 'GEMINI', 'NORTH', 'GMOS', 'DARK', 'RAW', 'NON_SIDEREAL', 'UNPREPARED'],
#    ('GMOS', 'S20160725S0008.fits') : ['GEMINI', 'SOUTH', 'GMOS', 'DARK', 'RAW', 'SIDEREAL', 'UNPREPARED', 'NODANDSHUFFLE'],
#
##   GMOS Arc
#    ('GMOS', 'S20160724S0218.fits') : ['CAL', 'GEMINI', 'SOUTH', 'GMOS', 'LS', 'ARC', 'RAW', 'SPECT', 'SIDEREAL', 'UNPREPARED'],
#    ('GMOS', 'N20160721S0351.fits') : ['AT_ZENITH', 'AZEL_TARGET', 'CAL', 'GEMINI', 'NORTH', 'GMOS', 'MOS', 'ARC', 'RAW', 'SPECT', 'NON_SIDEREAL', 'UNPREPARED'],
#    ('GMOS', 'N20160706S0220.fits') : ['CAL', 'GEMINI', 'NORTH', 'GMOS', 'IFU', 'ARC', 'ONESLIT_RED', 'RAW', 'SPECT', 'SIDEREAL', 'UNPREPARED'],
#    ('GMOS', 'S20060131S0131.fits') : ['CAL', 'GEMINI', 'SOUTH', 'GMOS', 'IFU', 'ARC', 'ONESLIT_BLUE', 'RAW', 'SPECT', 'SIDEREAL', 'UNPREPARED'],
#    ('GMOS', 'N20160421S0217.fits') : ['CAL', 'GEMINI', 'NORTH', 'GMOS', 'IFU', 'ARC', 'TWOSLIT', 'RAW', 'SPECT', 'SIDEREAL', 'UNPREPARED'],
#    ('GMOS', 'N20020829S0026.fits') : ['CAL', 'GEMINI', 'NORTH', 'GMOS', 'MOS', 'ARC', 'NODANDSHUFFLE', 'RAW', 'SPECT', 'SIDEREAL', 'UNPREPARED'],

#   GMOS Fringe
    # Those will only be recognized as PROCESSED FRINGE.  As raw, they
    # cannot be recognized.
    ('GMOS', 'N20110927S0170_fringe.fits') : ['FRINGE', 'GEMINI', 'NORTH', 'GMOS', 'IMAGE', 'OVERSCAN_SUBTRACTED', 'OVERSCAN_TRIMMED', 'PREPARED', 'PROCESSED', 'SIDEREAL'],
...
#    ('GMOS', 'N20120121S0175.fits') : ['ACQUISITION', 'GEMINI', 'NORTH', 'GMOS', 'IMAGE', 'SIDEREAL', 'RAW', 'UNPREPARED'],
#    ('GMOS', 'N20110718S0294.fits') : ['CAL', 'GEMINI', 'NORTH', 'GMOS', 'IMAGE', 'FLAT', 'TWILIGHT', 'SIDEREAL', 'RAW', 'UNPREPARED'],
#    ('GMOS', 'N20110718S0290_flat.fits') : ['CAL', 'GEMINI', 'NORTH', 'GMOS', 'IMAGE', 'FLAT', 'TWILIGHT', 'SIDEREAL', 'OVERSCAN_SUBTRACTED', 'OVERSCAN_TRIMMED', 'PREPARED', 'PROCESSED'],
#    ('GMOS', 'S20150903S0061.fits') : ['ACQUISITION', 'GEMINI', 'SOUTH', 'GMOS', 'IMAGE', 'SIDEREAL', 'RAW', 'UNPREPARED'],
#    ('GMOS', 'S20140625S0361.fits') : ['CAL', 'GEMINI', 'SOUTH', 'GMOS', 'IMAGE', 'FLAT', 'TWILIGHT', 'SIDEREAL', 'RAW', 'UNPREPARED'],
#
##   GMOS Longslit Data
#    ('GMOS', 'N20160726S0179.fits') : ['GEMINI', 'NORTH', 'GMOS', 'LS', 'RAW', 'SPECT', 'SIDEREAL', 'UNPREPARED'],
#    ('GMOS', 'S20091217S0032.fits') : ['GEMINI', 'SOUTH', 'GMOS', 'LS', 'NODANDSHUFFLE', 'RAW', 'SPECT', 'SIDEREAL', 'UNPREPARED'],
#    ('GMOS', 'N20160726S0180.fits') : ['CAL', 'GEMINI', 'NORTH', 'GMOS', 'LS', 'FLAT', 'GCALFLAT', 'RAW', 'SPECT', 'SIDEREAL', 'UNPREPARED'],
#    ('GMOS', 'N20160722S0284.fits') : ['CAL', 'GEMINI', 'NORTH', 'GMOS', 'LS', 'FLAT', 'TWILIGHT', 'RAW', 'SPECT', 'SIDEREAL', 'UNPREPARED'],
#       # This one is not working in the current system.  Doesn't detect
#       # it as TWILIGHT, nor FLAT.
#    ('GMOS', 'S20160722S0210.fits') : ['ACQUISITION', 'GEMINI', 'SOUTH', 'GMOS', 'IMAGE', 'RAW', 'SIDEREAL', 'UNPREPARED', 'MASK'],
...
#    ('GMOS', 'S20150417S0092.fits') : ['GEMINI', 'SOUTH', 'GMOS', 'MOS', 'NODANDSHUFFLE', 'RAW', 'SPECT', 'SIDEREAL', 'UNPREPARED'],
#    ('GMOS', 'N20160708S0096.fits') : ['CAL', 'GEMINI', 'NORTH', 'GMOS', 'MOS', 'FLAT', 'GCALFLAT', 'RAW', 'SPECT', 'SIDEREAL', 'UNPREPARED'],
#    ('GMOS', 'N20160605S0099.fits') : ['CAL', 'GEMINI', 'NORTH', 'GMOS', 'MOS', 'FLAT', 'TWILIGHT', 'RAW', 'SPECT', 'SIDEREAL', 'UNPREPARED'],
#       # This one is not working in the current system.  Doesn't detect
#       # it as TWILIGHT, nor FLAT.
#    ('GMOS', 'N20160708S0085.fits') : ['ACQUISITION', 'GEMINI', 'NORTH', 'GMOS', 'IMAGE', 'RAW', 'SIDEREAL', 'UNPREPARED', 'MASK'],
#       # New tag: MASK.  I think that
#       # the conditions will be GRATING == 'MIRROR' and MASKTYP != 0.
#
##   GMOS IFU Data
#    ('GMOS', 'N20160706S0218.fits') : ['GEMINI', 'NORTH', 'GMOS', 'IFU', 'ONESLIT_RED', 'RAW', 'SPECT', 'SIDEREAL', 'UNPREPARED'],
#    ('GMOS', 'S20060130S0079.fits') : ['GEMINI', 'SOUTH', 'GMOS', 'IFU', 'NODANDSHUFFLE', 'RAW', 'SPECT', 'SIDEREAL', 'UNPREPARED', 'TWOSLIT'],
#       # The two-slit nature is not identified in the old system.
#       # MASKNAME='IFU-NS-2' in that file.  the rule has 'IFU-2-NS', that
#       # appears to be wrong.
#    ('GMOS', 'N20160716S0148.fits') : ['CAL', 'GEMINI', 'NORTH', 'GMOS', 'IFU', 'FLAT', 'ONESLIT_RED', 'RAW', 'SPECT', 'SIDEREAL', 'UNPREPARED', 'GCALFLAT'],
#    ('GMOS', 'S20060131S0117.fits') : ['CAL', 'GEMINI', 'SOUTH', 'GMOS', 'IFU', 'FLAT', 'ONESLIT_BLUE', 'RAW', 'SPECT', 'SIDEREAL', 'UNPREPARED', 'GCALFLAT'],
#    ('GMOS', 'N20160524S0119.fits') : ['CAL', 'GEMINI', 'NORTH', 'GMOS', 'IFU', 'FLAT', 'TWOSLIT', 'RAW', 'SPECT', 'SIDEREAL', 'UNPREPARED', 'GCALFLAT'],
#    ('GMOS', 'N20160722S0285.fits') : ['CAL', 'GEMINI', 'NORTH', 'GMOS', 'IFU', 'FLAT', 'TWILIGHT', 'RAW', 'TWOSLIT', 'SPECT', 'SIDEREAL', 'UNPREPARED'],
#       # This one is not working in the current system.  Doesn't detect
#       # it as TWILIGHT, nor FLAT.
#    ('GMOS', 'N20160620S0373.fits') : ['CAL', 'GEMINI', 'NORTH', 'GMOS', 'IFU', 'FLAT', 'TWILIGHT', 'RAW', 'ONESLIT_RED', 'SPECT', 'SIDEREAL', 'UNPREPARED'],
#       # This one is not working in the current system.  Doesn't detect
#       # it as TWILIGHT, nor FLAT.
#    ('GMOS', 'S20051226S0033.fits') : ['CAL', 'GEMINI', 'NORTH', 'GMOS', 'IFU', 'FLAT', 'TWILIGHT', 'RAW', 'ONESLIT_BLUE', 'SPECT', 'SIDEREAL', 'UNPREPARED'],
#       # This one is not working in the current system.  Doesn't detect
#       # it as TWILIGHT, nor FLAT.
#    ('GMOS', 'N20160620S0317.fits') : ['ACQUISITION', 'GEMINI', 'NORTH', 'GMOS', 'IMAGE', 'RAW', 'SIDEREAL', 'UNPREPARED', 'MASK'],
#       # For tag MASK: GRATINGi == 'MIRROR' AND MASKTYP != 0
#  
##   GMOS N&S Data
...
## GNIRS Data
##   GNIRS Darks
#    ('GNIRS', 'N20140812S0150.fits') : ['AZEL_TARGET', 'CAL', 'GEMINI', 'NORTH', 'GNIRS', 'DARK', 'NON_SIDEREAL', 'RAW', 'UNPREPARED'],
...
#    ('GNIRS', 'N20160624S0263.fits') : ['ACQUISITION', 'GEMINI', 'NORTH', 'GNIRS', 'IMAGE', 'MASK', 'RAW', 'SIDEREAL', 'UNPREPARED'],
...
#    ('GNIRS', 'N20160726S0261.fits') : ['CAL', 'GEMINI', 'NORTH', 'GNIRS', 'XD', 'SPECT', 'RAW', 'SIDEREAL', 'UNPREPARED', 'FLAT', 'GCALFLAT', 'LAMPON'],
#       # this one is with the QH lamp.  not sure we need a tag for it.
#    ('GNIRS', 'N20160722S0232.fits') : ['CAL', 'GEMINI', 'NORTH', 'GNIRS', 'XD', 'SPECT', 'RAW', 'SIDEREAL', 'UNPREPARED', 'ARC'],
#       # tag ARC:  OBSTYPE == 'ARC'
#    ('GNIRS', 'N20160726S0301.fits') : ['CAL', 'GEMINI', 'NORTH', 'GNIRS', 'XD', 'SPECT', 'RAW', 'NON_SIDEREAL', 'UNPREPARED', 'PINHOLE', 'AZEL_TARGET'],
...
## NIFS Data
##   NIFS Darks
#    ('NIFS', 'N20160727S0077.fits') : ['CAL', 'AZEL_TARGET', 'GEMINI', 'NORTH', 'DARK', 'NIFS', 'NON_SIDEREAL', 'RAW', 'UNPREPARED'],
#
##   NIFS IFU
#    ('NIFS', 'N20110707S0196.fits') : ['GEMINI', 'NORTH', 'IFU', 'NIFS', 'SPECT', 'NON_SIDREAL', 'RAW', 'UNPREPARED'],
#    ('NIFS', 'N20160708S0134.fits') : ['GEMINI', 'NORTH', 'IFU', 'NIFS', 'SPECT', 'SIDEREAL', 'RAW', 'UNPREPARED'],
#    ('NIFS', 'N20160727S0078.fits') : ['CAL', 'AZEL_TARGET', 'GEMINI', 'NORTH', 'ARC', 'NIFS', 'IFU', 'SPECT', 'NON_SIDEREAL', 'RAW', 'UNPREPARED'],
#    ('NIFS', 'N20160727S0079.fits') : ['CAL', 'AZEL_TARGET', 'GEMINI', 'NORTH', 'FLAT', 'GCALFLAT', 'LAMPON', 'GCAL_IR_ON', 'IFU', 'NIFS', 'SPECT', 'NON_SIDEREAL', 'RAW', 'UNPREPARED'],
#    ('NIFS', 'N20160708S0119.fits') : ['ACQUISITION', 'GEMINI', 'NORTH', 'IFU', 'NIFS', 'SPECT', 'RAW', 'SIDEREAL', 'SPECT', 'UNPREPARED'],
#    ('NIFS', 'N20160705S0221.fits') : ['CAL', 'RONCHI', 'AZEL_TARGET', 'GEMINI', 'NORTH', 'IFU', 'NIFS', 'SPECT', 'NON_SIDEREAL', 'RAW', 'UNPREPARED'],
#
## F2 Data
##   F2 Darks
...
#    ('F2', 'S20160724S0130.fits') : ['CAL', 'F2', 'LS', 'FLAT', 'GCALFLAT', 'SPECT', 'GCAL_IR_ON', 'LAMPON', 'GEMINI', 'SOUTH', 'RAW', 'SIDEREAL', 'UNPREPARED'],
#    ('F2', 'S20160724S0129.fits') : ['CAL', 'F2', 'LS', 'ARC', 'SPECT', 'GEMINI', 'SOUTH', 'RAW', 'SIDEREAL', 'UNPREPARED'],
#    ('F2', 'S20160317S0053.fits') : ['ACQUISITION', 'F2', 'IMAGE', 'GEMINI', 'SOUTH', 'RAW', 'SIDEREAL', 'UNPREPARED'],
#    ('F2', 'S20160317S0055.fits') : ['ACQUISITION', 'F2', 'IMAGE', 'MASK', 'GEMINI', 'SOUTH', 'RAW', 'SIDEREAL', 'UNPREPARED'],
...
#    ('F2', 'S20120104S0055.fits') : ['ACQUISITION', 'F2', 'IMAGE', 'GEMINI', 'SOUTH', 'RAW', 'SIDEREAL', 'UNPREPARED', 'MASK'],
...
#    ('F2', 'S20150622S0004.fits') : ['ACQUISITION', 'F2', 'IMAGE', 'GEMINI', 'SOUTH', 'RAW', 'SIDEREAL', 'UNPREPARED', 'MASK'],
#    ('F2', 'S20150622S0005.fits') : ['F2', 'MOS', 'SPECT', 'GEMINI', 'SOUTH', 'NON_SIDEREAL', 'RAW', 'UNPREPARED'],
#    ('F2', 'S20150622S0008.fits') : ['CAL', 'F2', 'MOS', 'ARC', 'SPECT', 'GEMINI', 'SOUTH', 'NON_SIDEREAL', 'RAW', 'UNPREPARED'],
#    ('F2', 'S20150624S0172.fits') : ['CAL', 'F2', 'MOS', 'FLAT', 'GCALFLAT', 'LAMPON', 'GCAL_IR_ON', 'SPECT', 'GEMINI', 'SOUTH', 'NON_SIDEREAL', 'RAW', 'UNPREPARED'],
#
## GSAOI Data
##   GSAOI Darks
#    ('GSAOI', 'S20160422S0150.fits') : ['AT_ZENITH', 'AZEL_TARGET', 'CAL', 'GEMINI', 'SOUTH', 'GSAOI', 'DARK', 'IMAGE', 'NON_SIDEREAL', 'RAW', 'UNPREPARED'],
#
##   GSAOI Imaging
