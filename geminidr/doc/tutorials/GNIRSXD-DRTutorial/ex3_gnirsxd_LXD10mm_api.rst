.. ex3_gnirsxd_LXD10mm_api.rst

.. include:: symbols.txt

.. _gnirsxd_LXD10mm_api:

**************************************************************
Example 3 - LXD+10 Point Source - Using the "Reduce" class API
**************************************************************

MGR NOTE: The figure PNG FILES ALL STILL NEED TO BE GENERATED!

In this example, we will reduce the GNIRS crossed-dispersed observation of
a bright HD star using the Python programmatic interface.

This cross-dispersed observation uses the 10 l/mm grating, the long-blue
camera, and the 0.10 arcsec slit.   The dither pattern is the standard ABBA
repeated 3 times.
...
.. code-block:: python
    ...
    scitarget = dataselect.select_data(
        ...
        [],
        ['CAL'],
        dataselect.expr_parser('observation_class=="science" and object=="HD 137391"')
    )
...
::
   ...
   ad = astrodata.open('N20170219S0341_extracted.fits')
...
::
   ...
   from gempy.adlibrary import plotting
   ad = astrodata.open('N20170219S0341_telluricCorrected.fits')
   plotting.dgsplot_matplotlib(ad, 1, kwargs={'linewidth':0.5})
...
::
   ...
   from gempy.adlibrary import plotting
   ad = astrodata.open('N20170219S0341_ordersCombined.fits')
   plotting.dgsplot_matplotlib(ad, 1, kwargs={'linewidth':0.5})
