.. ex3_gnirsxd_LXD10mm_cmdline.rst

.. include:: symbols.txt

.. _gnirsxd_LXD10mm_cmdline:

*****************************************************************
Example 3 - LXD+10 Point Source - Using the "reduce" command line
*****************************************************************

In this example, we will reduce the GNIRS crossed-dispersed observation of
a bright HD star using the "|reduce|" command that
is operated directly from the unix shell.  Just open a terminal and load the
DRAGONS conda environment to get started.

This cross-dispersed observation uses the 10 l/mm grating, the long-blue
camera, and the 0.1 arcsec slit.   The dither pattern is the standard ABBA
repeated 3 times.
...
::
    ...
    dataselect ../playdata/example3/*.fits --tags PINHOLE -o pinholes.lis
...
::
    ...
    filename                                    object
    --------------------------------------------------
    ../playdata/example3/N20170219S0341.fits   HD 137391
    ../playdata/example3/N20170219S0342.fits   HD 137391
    ../playdata/example3/N20170219S0343.fits   HD 137391
    ...
    ../playdata/example3/N20170219S0350.fits   HD 137391
    ../playdata/example3/N20170219S0351.fits   HD 137391
    ../playdata/example3/N20170219S0352.fits   HD 137391
...
::
    ...
    dataselect ../playdata/example3/*.fits --expr='observation_class=="science" and object=="HD 137391"' -o sci.lis
...
.. image:: _graphics/gnirsxd_LXD10mm_pinhole.png
   :width: 400
...
Telluric Standard
=================
The telluric standard observed before the science observation is "hip 71172".
...
to store them.  In a normal text file (here we name it "hip71172.param"), we write::

    -p
    fitTelluric:bbtemp=9700
    fitTelluric:magnitude='K=8.846'
...
::
    ...
    reduce @telluric.lis -r reduceTelluric @hip71172.param -p fitTelluric:interactive=True

The fit for Order 3 looks like this:

.. image:: _graphics/gnirsxd_LXD10mm_tellfit_order3.png
   :width: 600
...
is 3 ABBA dither pattern. DRAGONS will flatfield, wavelength calibrate,
...
.. image:: _graphics/gnirsxd_LXD10mm_raw.png
   :width: 400
...
::
    ...
    dgsplot N20170219S0341_extracted.fits 1 --thin

.. image:: _graphics/gnirsxd_LXD10mm_extracted.png
   :width: 450
...
::
    ...
    dgsplot N20170219S0341_telluricCorrected.fits 1 --thin


.. image:: _graphics/gnirsxd_LXD10mm_tellcor.png
   :width: 600
...
::
    ...
    dgsplot N20170219S0341_1D.fits 1 --thin

.. image:: _graphics/gnirsxd_LXD10mm_1d.png
   :width: 600
...
::
    ...
    dgsplot N20170219S0341_ordersCombined.fits 1 --thin

.. image:: _graphics/gnirsxd_LXD10mm_ordersCombined.png
   :width: 600
