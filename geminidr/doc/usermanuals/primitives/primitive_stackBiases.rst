...
stackBiases
***********
This primitive stacks a set of user-specified bias frames. No
...
* :ref:`primitive_stackBiases_core.stack`

.. _primitive_stackBiases.stack:
...
.. include:: generated_doc/geminidr.core.primitives_stack.Stack.stackBiases_docstring.rst
...
.. include:: generated_doc/geminidr.core.primitives_stack.Stack.stackBiases_param.rst

Algorithm
---------
This primitive makes use of the more-general stackFrames primitive.

For the stackBiases primitive, no scaling or offsetting is applied.
...
----------------------
All input frames must contain the 'BIAS' tag.
