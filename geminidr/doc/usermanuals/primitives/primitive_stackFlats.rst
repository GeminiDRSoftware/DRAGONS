...
stackFlats
*************
This primitive stacks a set of user-specified flat field frames. No
...
* :ref:`primitive_stackFlats_core.stack`

.. _primitive_stackFlats.stack:
...
.. include:: generated_doc/geminidr.core.primitives_stack.Stack.stackFlats_docstring.rst
...
.. include:: generated_doc/geminidr.core.primitives_stack.Stack.stackFlats_param.rst

Algorithm
---------
This primitive makes use of the more-general stackFrames primitive.

For the stackFlats primitive, no scaling or offsetting is applied.
