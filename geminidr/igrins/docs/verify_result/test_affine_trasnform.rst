...
.. container:: cell
   ...
   .. container:: cell-output cell-output-stderr
      ...
      ::
         ...
         /tmp/ipykernel_51775/3918233050.py:8: UserWarning: Boolean Series key will be reindexed to match DataFrame index.
           plt.plot(df_tgt[msk]["xpos"], df_tgt[msk]["order"], "o")
         /tmp/ipykernel_51775/3918233050.py:8: UserWarning: Boolean Series key will be reindexed to match DataFrame index.
           plt.plot(df_tgt[msk]["xpos"], df_tgt[msk]["order"], "o")
   ...
   .. container:: cell-output cell-output-display
      ...
      .. image:: test_affine_trasnform_files/figure-rst/cell-5-output-2.png
...
.. container:: cell
   ...
   .. container:: cell-output cell-output-display
      ...
      .. image:: test_affine_trasnform_files/figure-rst/cell-7-output-1.png
