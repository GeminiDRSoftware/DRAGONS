...
INPUT_FILES = ["N20260303S0028_K_varAdded.fits"]
...
def test_adu_to_electrons(path_to_refs, ad):
    """A simple test for the IGRINS2 ADUToElectrons primitive."""
    p = IGRINS2Spect([ad])
    adout = p.ADUToElectrons().pop()
