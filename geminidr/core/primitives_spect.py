...
#
#
#     def extract1DSpectra(self, adinputs, **params):
#
#         # Instantiate the log
#         log = logutils.get_logger(__name__)
#
...
#         yield rc
#
#     def makeFlat(self, adinputs, **params):
#
#         # Instantiate the log
#         log = logutils.get_logger(__name__)
#
...
#         yield rc
#
#     def rejectCosmicRays(self, adinputs, **params):
#
#         # Instantiate the log
#         log = logutils.get_logger(__name__)
#
...
#
#
#     def resampleToLinearCoords(self, adinputs, **params):
#
#         # Instantiate the log
#         log = logutils.get_logger(__name__)
#
...
#         yield rc
#
#     def skyCorrectFromSlit(self, adinputs, **params):
#
#         # Instantiate the log
#         log = logutils.get_logger(__name__)
#
