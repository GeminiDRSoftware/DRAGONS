...
class standardizeHeadersConfig(standardizeObservatoryHeadersConfig,
                               standardizeInstrumentHeadersConfig):
    def setDefaults(self):
...
class prepareConfig(standardizeHeadersConfig, standardizeStructureConfig,
                    standardizeWCSConfig, validateDataConfig):
    def setDefaults(self):
