...
def test_shift_images(trim_data, file_write, path_to_outputs):
    """
    ...
    for xoff, yoff in offsets:
        ...
        ad[0].add_star(amplitude=1000, x=512-xoff, y=512-yoff)
    ...
    for ad in p.streams['main']:
        ...
        assert np.unravel_index(ad[0].data.argmax(), ad[0].shape) == peak_loc
