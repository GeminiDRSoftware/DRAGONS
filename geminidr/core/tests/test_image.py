...
def test_scale_by_object_flux(p_niri, tolerance, use_common):
    expected_results = {(0, False): (1, 1/2, 1/3),
                        (0, True): (1, 1/2, 1/3),
                        (1, False): (1, 170100/170201, 100200/100404),
                        (1, True): (1, 100/101, 100/102)}

    p_niri.scaleByObjectFlux(tolerance=tolerance, use_common=use_common)
    adoutputs = p_niri.streams['main']
