        ...
        var columns = [
            ...
            field:"metadata-local_time_str", width:50,
                swap: "metadata-ut_time_str", alt_name:"UT"},
                       {id:"imgnum", name:"Img#",
            field:"metadata-image_number", width:40},
               {id:"datalabel",    name:"Data Label",
            field:"metadata-datalabel", width:160},
               {id:"wlen", name:"Wvlen",
            field:"metadata-wavelength_str", width:60},
               {id:"iq", name:"IQ",
            field:"iq-band_str", width:50},
               {id:"cc", name:"CC",
            field:"cc-band_str", width:100},
               {id:"bg", name:"BG",
            field:"bg-band_str", width:60},
               {id:"deliq", name:"Delivered IQ",
            field:"iq-delivered_str", width:110},
               {id:"zeniq", name:"Zenith IQ",
            field:"iq-zenith_str",width:90},
                {id:"strehl", name:"Strehl",
            field:"iq-strehl_str",width:60},
               {id:"zeropt", name:"Zeropoint",
            field:"cc-zeropoint_str",width:80},
               {id:"extinc", name:"Extinction",
            field:"cc-extinction_str",width:90},
               {id:"sky", name:"Sky Mag",
            field:"bg-brightness_str",width:80}
               ]; // end columns
