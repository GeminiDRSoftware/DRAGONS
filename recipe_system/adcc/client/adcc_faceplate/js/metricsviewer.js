...
MetricsViewer.prototype = {
    ...
    var columns = [
            ...
            field:"iq-band_str", width:54},
               {id:"cc", name:"CC",
            field:"cc-band_str", width:64},
               {id:"bg", name:"BG",
            field:"bg-band_str", width:64},
               {id:"deliq", name:"Delivered IQ",
            field:"iq-delivered_str", width:80},
               {id:"zeniq", name:"Zenith IQ",
            field:"iq-zenith_str",width:80},
                {id:"strehl", name:"Strehl",
            field:"iq-strehl_str",width:50},
               {id:"zeropt", name:"Zeropoint",
            field:"cc-zeropoint_str",width:80},
               {id:"extinc", name:"Extinction",
            field:"cc-extinction_str",width:80},
               {id:"sky", name:"Sky Mag",
