# -*- coding: utf-8 -*-
#
# GSAOI Programmer's Manual documentation build configuration file, created by
# sphinx-quickstart on Thu Feb 27 11:49:09 2014.
#
...
project = u'GSAOI Programmer\'s Manual'
copyright = u'2014, Mark Simpson'
...
htmlhelp_basename = 'GSAOIProgrammersManualdoc'
...
latex_documents = [
  ('index-latex', 'GSAOIProgrammersManual.tex', u'GSAOI Programmer\'s Manual',
