...
nominal_zeropoints = {
    ...
    # GMOS-N Hamamatsu CCDs
    # Values for g, r, i, z provided by Teo Mocnick on Dec 5, 2025
    # Table updated on Jan 8, 2026.
    # Values for OVI and OVIC are the previous ones from unknown origin.
    #
    # CCDr = BI13-20-4k-1
    # CCDg = BI12-09-4k-2
    # CCDb = BI13-18-4k-2
    ('BI13-20-4k-1', 'g'): 27.915,  # 0.026,
    ('BI12-09-4k-2', 'g'): 27.915,  # 0.026,
    ('BI13-18-4k-2', 'g'): 27.915,  # 0.026,
    ('BI13-20-4k-1,BI12-09-4k-2,BI13-18-4k-2', 'g'): 27.915,  # 0.026
    ('BI13-20-4k-1', 'r'): 28.299,  # 0.025,
    ('BI12-09-4k-2', 'r'): 28.299,  # 0.025,
    ('BI13-18-4k-2', 'r'): 28.299,  # 0.025,
    ('BI13-20-4k-1,BI12-09-4k-2,BI13-18-4k-2', 'r'): 28.299,  # 0.025
    ('BI13-20-4k-1', 'i'): 28.410,  # 0.026,
    ('BI12-09-4k-2', 'i'): 28.410,  # 0.026,
    ('BI13-18-4k-2', 'i'): 28.410,  # 0.026,
    ('BI13-20-4k-1,BI12-09-4k-2,BI13-18-4k-2', 'i'): 28.410,  # 0.026
    ('BI13-20-4k-1', 'z'): 28.222,  # 0.035,
    ('BI12-09-4k-2', 'z'): 28.222,  # 0.035,
    ('BI13-18-4k-2', 'z'): 28.222,  # 0.035,
    ('BI13-20-4k-1,BI12-09-4k-2,BI13-18-4k-2', 'z'): 28.222,  # 0.035,
