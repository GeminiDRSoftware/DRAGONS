...
Package as of |date|, and show descriptor and primitive set assignments when present.
...
Gemini AstroData Types Reference
--------------------------------
...
.. include:: gen.typedefs/gen.TypeSourceAppendix.rst
