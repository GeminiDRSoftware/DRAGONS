...
if (options.listdescriptors):
    ...
    try:
        dt.typewalk(options.twdir, only=options.only,
                    ...
                    # Now the descriptors, in alphabetical order
                    showairmass = options.showairmass,
                    showcamera = options.showcamera,
                    showcwave = options.showcwave,
                    showdatasec = options.showdatasec,
                    showdetsec = options.showdetsec,
                    showdisperser = options.showdisperser,
                    showexptime = options.showexptime,
                    showfiltername = options.showfiltername,
                    showfilterid = options.showfilterid,
                    showfpmask = options.showfpmask,
                    showgain = options.showgain,
                    showinstrument = options.showinstrument,
                    showmdfrow = options.showmdfrow,
                    shownonlinear = options.shownonlinear,
                    shownsciext = options.shownsciext,
                    showobject = options.showobject,
                    showobsmode = options.showobsmode,
                    showpixscale = options.showpixscale,
                    showrdnoise = options.showrdnoise,
                    showsatlevel = options.showsatlevel,
                    showutdate = options.showutdate,
                    showuttime = options.showuttime,
                    showwdelta = options.showwdelta,
                    showwrefpix = options.showwrefpix,
                    showxbin = options.showxbin,
                    showybin = options.showybin)
