...
# Note: this file was copied from Astropy, to maintain compatibility with
# Astropy < 3.1. So when Astropy 3.1 becomes the minimum required version for
# Dragons this can be removed.
