...
SCREEN_FORMAT = logging.Formatter( "%(levelname)-8s %(message)s" )  
...
def defaultInit( name="", logfile="", verbose=False, errorlogfile="", debug=True ):
    ...
    ## Check if logFile acceptable ...etc    #$$ Next 6 line brick commented out to remove duplicate log
    #if logfile == "":
    #    logfile = "gemini.log"
    ...
    if errorlogfile == "":
        #errorlogfile = "geminiError.log"  #$$$ commented out as i don't like this name
...
def getLogger( name="", logfile="", verbose=False, debug=True, errorlogfile="" ):
    ...
    if logName == None:
        ### This is a workaround to get it to not have logName = checkImageParam
        # print 'gemLogger103: initial input name = ', name 
        if name == 'checkImageParam':
            name = 'Logger'
        # print 'gemlogger103: calling the defaultInit, passing name(new) = ', name #$$$$$$$$$$$$$$$$$$$$$$$$
