    ...
    stages {
            ...
            parallel {
                ...
                stage('Unit tests') {
                    ...
                    steps {
                        ...
                        sh 'tox -e py39-unit -v -r -- --basetemp=${DRAGONS_TEST_OUT} --junit-xml reports/unittests_results.xml ${TOX_ARGS}'
                    ...
                    post {
                        always {
                            junit (
                                ...
                                testResults: '.tmp/py39-unit/reports/*_results.xml'
                            )
        ...
        //                }
                ...
                stage('Integration tests') {
                    ...
                    steps {
                        ...
                        sh 'tox -e py39-integ -v -r -- --basetemp=${DRAGONS_TEST_OUT} --junit-xml reports/integration_results.xml ${TOX_ARGS}'
                    ...
                    post {
                        always {
                            junit (
                                allowEmptyResults: true,
                                testResults: '.tmp/py39-integ/reports/*_results.xml'
                            )
                ...
                stage('Regression Tests') {
                    ...
                    steps {
                        ...
                        sh 'tox -e py39-reg -v -r -- --basetemp=${DRAGONS_TEST_OUT} --junit-xml reports/regression_results.xml ${TOX_ARGS}'
                        echo "Reporting coverage"
                    ...
                    post {
                        always {
                            junit (
                                allowEmptyResults: true,
                                testResults: '.tmp/py39-reg/reports/*_results.xml'
                            )
        ...
        stage('F2 Tests') {
            ...
            steps {
                ...
                sh '.jenkins/scripts/setup_agent.sh'
                echo "Running tests"
                sh 'tox -e py39-f2 -v -- --basetemp=${DRAGONS_TEST_OUT} --junit-xml reports/f2_results.xml ${TOX_ARGS}'
                echo "Reporting coverage"
            ...
            post {
                always {
                    ...
                    junit (
                        allowEmptyResults: true,
                        testResults: '.tmp/py39-f2/reports/*_results.xml'
                    )
        ...
        stage('GSAOI Tests') {
            ...
            steps {
                ...
                sh '.jenkins/scripts/setup_agent.sh'
                echo "Running tests"
                sh 'tox -e py39-gsaoi -v -- --basetemp=${DRAGONS_TEST_OUT} --junit-xml reports/gsaoi_results.xml ${TOX_ARGS}'
                echo "Reporting coverage"
            ...
            post {
                always {
                    ...
                    junit (
                        allowEmptyResults: true,
                        testResults: '.tmp/py39-gsaoi/reports/*_results.xml'
                    )
        ...
        stage('NIRI Tests') {
            ...
            steps {
                ...
                sh '.jenkins/scripts/setup_agent.sh'
                echo "Running tests"
                sh 'tox -e py39-niri -v -- --basetemp=${DRAGONS_TEST_OUT} --junit-xml reports/niri_results.xml ${TOX_ARGS}'
                echo "Reporting coverage"
            ...
            post {
                always {
                    ...
                    junit (
                        allowEmptyResults: true,
                        testResults: '.tmp/py39-niri/reports/*_results.xml'
                    )
        ...
        stage('GNIRS Tests') {
            ...
            steps {
                ...
                sh '.jenkins/scripts/setup_agent.sh'
                echo "Running tests"
                sh 'tox -e py39-gnirs -v -- --basetemp=${DRAGONS_TEST_OUT} --junit-xml reports/gnirs_results.xml ${TOX_ARGS}'
                echo "Reporting coverage"
            ...
            post {
                always {
                    ...
                    junit (
                        allowEmptyResults: true,
                        testResults: '.tmp/py39-gnirs/reports/*_results.xml'
                    )
        ...
        stage('WaveCal Tests') {
            ...
            steps {
                ...
                sh '.jenkins/scripts/setup_agent.sh'
                echo "Running tests"
                sh 'tox -e py39-wavecal -v -- --basetemp=${DRAGONS_TEST_OUT} --junit-xml reports/wavecal_results.xml ${TOX_ARGS}'
                echo "Reporting coverage"
            ...
            post {
                always {
                    ...
                    junit (
                        allowEmptyResults: true,
                        testResults: '.tmp/py39-wavecal/reports/*_results.xml'
                    )
            ...
            parallel {
                stage('GMOS LS Tests') {
                    ...
                    steps {
                        ...
                        sh '.jenkins/scripts/setup_agent.sh'
                        echo "Running tests"
                        sh 'tox -e py39-gmosls -v -- --basetemp=${DRAGONS_TEST_OUT} --junit-xml reports/gmosls_results.xml ${TOX_ARGS}'
                        echo "Reporting coverage"
                    ...
                    post {
                        always {
                            ...
                            junit (
                                allowEmptyResults: true,
                                testResults: '.tmp/py39-gmosls/reports/*_results.xml'
                            )
                ...
                stage('Slow Tests') {
                    ...
                    steps {
                        ...
                        sh '.jenkins/scripts/setup_agent.sh'
                        echo "Slow tests"
                        sh 'tox -e py39-slow -v -- --basetemp=${DRAGONS_TEST_OUT} --junit-xml reports/slow_results.xml ${TOX_ARGS}'
                        echo "Reporting coverage"
                    ...
                    post {
                        always {
                            junit (
                                allowEmptyResults: true,
                                testResults: '.tmp/py39-slow/reports/*_results.xml'
                            )
                            echo "Deleting GMOS LS Tests workspace ${env.WORKSPACE}"
                            cleanWs()
                            dir("${env.WORKSPACE}@tmp") {
